...
<li class=""><a href="<?php echo SITE_URL; ?>"><i class="fa fa-plus" aria-hidden="true"></i> Start Exchange</a></li>
...
<li class="divider "></li>
<li class=""><a href="<?php echo SITE_URL; ?>logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo CBE1_ACCOUNT_LOGOUT; ?></a></li>