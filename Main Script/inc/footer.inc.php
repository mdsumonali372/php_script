	...
	<div class="row" style="display:inline-block">
		...
		<div class="col-md-3">
			<br><a href="<?php echo SITE_URL; ?>"><img src="<?php echo SITE_URL; ?>images/logo.png" width="140"></a><br>
		...
		<div class="col-md-3">
			<p class="copyright" style="white-space: nowrap">&copy; <?php echo date("Y"); ?> <?php echo SITE_TITLE; ?> All Rights Reserved</p>
		</div>
