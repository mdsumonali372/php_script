<?php
	...
	/// MySQL Settings ///
	define('DB_NAME', 'nullphpscript');	// MySQL database name
	define('DB_USER', 'nullphpscript');	// MySQL database user
	define('DB_PASSWORD', 'TN1wp3Eq5oTa');		// MySQL database password
